...
<img className='w-5 h-5' src={assets.role} alt="" />
<p className='hidden md:block'>Role Details</p>
    </NavLink>
    <NavLink className="flex items-center gap-3 border border-gray-300 border-r-0 px-3 py-2 rounded-lg" to="/RoleList">
<img className='w-5 h-5' src={assets.per} alt="" />
<p className='hidden md:block'>Role Permisions</p>
    </NavLink>
</div>
